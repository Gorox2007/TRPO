...
class Stage4CoreTests(unittest.TestCase):
    def test_rank_candidates_orders_by_score(self) -> None:
        ...
        repo = FakeRepository(
            ...
            preferences={
                viewer.telegram_id: PreferenceRecord(24, 30, "female", "Москва", 50),
            },
            candidates={
                viewer.id: [
    ...
    def test_rank_candidates_limit_returns_only_top_n(self) -> None:
        ...
        repo = FakeRepository(
            ...
            preferences={
                viewer.telegram_id: PreferenceRecord(23, 32, "female", "Москва", 50),
            },
            candidates={
                viewer.id: [
    ...
    def test_get_next_candidate_uses_precached_batch(self) -> None:
        ...
        repo = FakeRepository(
            users=[viewer, candidate_a, candidate_b],
            preferences={
                viewer.telegram_id: PreferenceRecord(22, 32, "female", "Москва", 50),
            },
            candidates={
                viewer.id: [
